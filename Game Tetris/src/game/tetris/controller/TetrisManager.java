package game.tetris.controller;
...
import game.tetris.constant.Constant.BoardType;
import game.tetris.constant.Constant.GameStatus;
import game.tetris.model.Block;
...
public class TetrisManager {
	...
	public void print(Graphics graphics) {
		...
		graphics.drawString("Deleted lines : " + mDeletedLineCount + " lines",
				x, y);
		y += 50;
		graphics.drawString("Game Score : " + mScore + " 점", x, y);
